		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid" style="padding-top: 1.5rem;">
					...
					<h1 class="h3 mb-2 text-gray-800">Editar Trabajo de Grado</h1>

					<div class="card shadow mb-4">
						<div class="card-body">
							<div class="panel-body">
								<form id="libroform" class="form-horizontal row-border" action="<?php echo base_url(); ?>actualizar_tdg" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											<input id="editorial" class="form-control" type="text" name="tutor" required autofocus value="<?php echo $tutor; ?>">
											<span class="help-block"><small><small>Debe ser exactamente como lo muestra el libro</small></small></span>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											...
											<span class="help-block"><small><small><b>Cargue nuevamente el trabajo de grado,</b> Debe ser en formato PDF</small></small></span>
										</div>
									</div>
