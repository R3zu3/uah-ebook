		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid" style="padding-top: 1.5rem;">
					...
					<h1 class="h3 mb-2 text-gray-800">Cargar Trabajo de Grado</h1>

					<div class="card shadow mb-4">
						<div class="card-body">
							<div class="panel-body">
								<form id="libroform" class="form-horizontal row-border" action="<?php echo base_url(); ?>subir_tdg" method="post" enctype="multipart/form-data">
