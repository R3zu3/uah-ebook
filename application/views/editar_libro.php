...
foreach ($libro as $key) {
	$cod_materia = $key->cod_materia;
	$cod_libro = $key->cod_libro;
	$titulo = $key->libro;
	$autor = $key->autor;
	$editorial = $key->editorial;
	$publicacion = $key->publicacion;
	$aceptado = $key->aceptado;
}
...
<body id="page-top" class="sidebar-toggled">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid" style="padding-top: 1.5rem;">
					...
					<h1 class="h3 mb-2 text-gray-800">Editar Libro</h1>

					<div class="card shadow mb-4">
						<div class="card-body">
							<div class="panel-body">
								<form id="libroform" class="form-horizontal row-border" action="<?php echo base_url(); ?>actualizar_libro" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<label class="col-md-2 control-label">Titulo</label>
										<div class="col-md-12">
											<input id="titulo" class="form-control" type="text" name="titulo" required autofocus value="<?php echo $titulo; ?>">
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											<input id="autor" class="form-control" type="text" name="autor" required autofocus value="<?php echo $autor; ?>">
											<span class="help-block"><small><small>Debe ser exactamente como lo muestra el libro</small></small></span>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-12">
											<input id="editorial" class="form-control" type="text" name="editorial" required autofocus value="<?php echo $editorial; ?>">
											<span class="help-block"><small><small>Debe ser exactamente como lo muestra el libro</small></small></span>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-12">
											<input id="publicacion" class="form-control" type="date" name="publicacion" required autofocus value="<?php echo $publicacion; ?>">
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											...
											<span class="help-block"><small><small>Seleccione la materia a la que pertenece el libro</small></small></span>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-12">
											...
											<span class="help-block"><small><small><b>Cargue nuevamente el libro,</b> Debe ser en formato PDF</small></small></span>
										</div>
									</div>
									<input type="hidden" name="idlibro" required autofocus value="<?php echo $cod_libro; ?>">
									<div class="form-group">
			...
			<footer class="sticky-footer bg-white">
				<div class="container my-auto">
					<div class="copyright text-center my-auto">
						<span><p> Copyright &copy; 2019 Universidad Alejadro de Humdoldt | Designed by <em> Renzo Zue & Khristofer Ramirez</em></p></span>
					</div>
				</div>
			</footer>
	...
	<script type="text/javascript">
		...
		$pieces = explode("-", $publicacion);

		?>

		var fecha = '<?php echo $pieces[0]."-".$pieces[1]."-".$pieces[2]; ?>';
		$('#publicacion').val(fecha);

		var materia = <?php echo $cod_materia; ?>;
		$('#materia').val(materia);
